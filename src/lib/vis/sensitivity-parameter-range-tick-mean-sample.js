...
export class SensitivityParameterRangeTickSampleMean {

  constructor(options) {
    const data = options.data[0].values
    let colors = ["#E69F00", "#009E73", "#DB4D56", "#0072B2", "#D55E00", "#D35FB7", "#56B4E9"];
    ...
    const createMeanSampleDiv = clusters => {
      let currentChart = document.createElement("div")
        ...
        currentChart.setAttribute("style", "width: 80%; vertical-align: top; margin-left:34%");
    ...
    const drawparameterRangePlot = clusters => {
        ...
        visFactory("SensitivityParameterRangeTickChart", {
