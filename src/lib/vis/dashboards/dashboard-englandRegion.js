...
export class DashboardEnglandRegion {
  ...
  constructor(options) {
    ...
    console.log(
      "PHE_REGION_CASES_VACCINE",
      Data.from(options.data, Data.Fields.PHE_REGION_CASES_VACCINE),
    );
    ...
    console.log(
      "PHE_REGION_FEMALE_CASES",
      Data.from(options.data, Data.Fields.PHE_REGION_FEMALE_CASES),
    );

    // var maleCases = "https://api.coronavirus.data.gov.uk/v2/data?areaType=region&areaCode=E12000007&metric=maleCases&format=csv"
    console.log(
      "PHE_REGION_MALE_CASES",
      Data.from(options.data, Data.Fields.PHE_REGION_MALE_CASES),
    );
    ...
    console.log(
      ...
      Data.from(options.data, Data.Fields.PHE_REGION_CASES_AGE),
    );
    ...
    console.log(
      "PHE_REGION_DEATHS",
      Data.from(options.data, Data.Fields.PHE_REGION_DEATHS),
    );
    ...
    console.log(
      "PHE_REGION_FEMALE_DEATHS",
      Data.from(options.data, Data.Fields.PHE_REGION_FEMALE_DEATHS),
    );
    ...
    console.log(
      "PHE_REGION_MALE_DEATHS",
      Data.from(options.data, Data.Fields.PHE_REGION_MALE_DEATHS),
    );
    ...
    console.log(
      ...
      Data.from(options.data, Data.Fields.PHE_REGION_VACCINE_AGE),
    );
        ...
        },
        {
          ...
          layout: [
            [
              ...
              ["vaccinationsAgeDemographics1", "vaccinationsAgeDemographics2"],
            ],
          ],
        },
        {
          ...
          layout: [
            [
              ...
              ["femaleDeaths28Days", "maleDeaths28Days"],
            ],
          ],
        },
      ],
