...
export class DashboardUK {
  ...
  constructor(options) {
    ...
    var newCasesBySpecimenDate_all =
      "https://api.coronavirus.data.gov.uk/v2/data?areaType=nation&metric=newCasesBySpecimenDate&format=csv";
    var newAdmissionsRollingSum =
      "https://api.coronavirus.data.gov.uk/v2/data?areaType=nation&metric=newAdmissionsRollingSum&format=csv";
    var newOnsDeathsByRegistrationDate_all =
      "https://api.coronavirus.data.gov.uk/v2/data?areaType=nation&metric=newOnsDeathsByRegistrationDate&format=csv";
    var newCasesBySpecimenDateChangePercentage_councils =
      "https://api.coronavirus.data.gov.uk/v2/data?areaType=ltla&metric=newCasesBySpecimenDateChangePercentage&format=csv";
    var newCasesBySpecimenDateChangePercentage_all =
      "https://api.coronavirus.data.gov.uk/v2/data?areaType=nation&metric=newCasesBySpecimenDateChangePercentage&format=csv";
    ...
    d3.csv(newCasesBySpecimenDateChangePercentage_councils).then(function (
      data,
    ) {
      ...
      var config = {
        ...
        widgets: [
          ...
          // DEATHS
          {
            ...
            data: Data.from(
              options.data,
              Data.Fields.PHE_UK_CUM_DEATHS_28_DAYS,
            ),
