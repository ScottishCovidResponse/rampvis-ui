...
export class SimpleLineChart {
  ...
  constructor(options) {
    ...
    const tooltip_linechart = d3
      .select("body")
      .append("div")
      .attr("class", "tool-tip-line-chart");
    ...
    let path = g
      ...
      .on("mouseout", function (d) {
        tooltip_linechart.style("display", "none");
      });
    ...
    let focus = g.append("g").attr("class", "focus").style("display", "none");
