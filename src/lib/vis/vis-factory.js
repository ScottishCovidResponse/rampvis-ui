...
export const visFactory = (type, args) => {
  ...
  // Dashboards
  if (type === "DashboardScotlandCouncil")
    return new DashboardScotlandCouncil(args);
  if (type === "DashboardScotlandNHSBoard")
    return new DashboardScotlandNHSBoard(args);
  ...
  if (type === "DashboardEnglandNHSRegion")
    return new DashboardEnglandNHSRegion(args);
  if (type === "DashboardEnglandRegion")
    return new DashboardEnglandRegion(args);
  if (type === "DashboardRiskMonitoring")
    return new DashboardRiskMonitoring(args);
