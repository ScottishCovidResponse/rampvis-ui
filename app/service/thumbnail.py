...
class Screenshot:
    ...
    def full_Screenshot(self, driver: WebDriver, save_path: str = '', image_name: str = 'selenium_full_screenshot.png',
        ...
        if isinstance(driver, webdriver.Ie):
            ...
            print(total_width, total_height, viewport_width, viewport_height)
...
if __name__ == '__main__':
    # url = 'http://0.0.0.0:5000/top-level-overview-screen-a'
    url = 'http://0.0.0.0:5000/mse'
    ...
    element = driver.find_element_by_id("charts")
    location = element.location
    size = element.size
    print('element = ', element, ', location = ', location, ', size = ', size)

    # ob = Screenshot()
    # Hide_elements = ['class=sidebar']  # Use full class name
